...
This skill is a vital link in the **[@brain-context-engineering](../SKILL.md)** master chain. When this skill is activated, you MUST also evaluate context through its sibling skills:
...
> [!IMPORTANT]
> This skill should rarely be used in isolation. Refer to the root `@brain-context-engineering` for the full context management routine.
