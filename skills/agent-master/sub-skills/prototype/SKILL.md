...
Use this skill for:
- Building throwaway prototypes to test state machines, data models, or API shapes
- Generating radically different UI variations to compare
- Rapid experimentation between brainstorming and planning phases

Do NOT use this skill for:
- Initial ideation — use `brainstorming`
- Writing implementation plans — use `writing-plans`
- Building production code — use `executing-plans`
