...
- For **Systemic Integrity**, Clean Architecture, and DDD:
  👉 **[Software Architecture Excellence](sub-skills/software-architecture/SKILL.md)**
- For **Site Architecture** and Design Standards:
  👉 **[Architecture Design](sub-skills/architecture-design/SKILL.md)**
- For **Domain Driven Design** and Context Mapping:
...
- For **REST/GraphQL API Design**:
  👉 **[API Design](sub-skills/api-design/SKILL.md)**
- For **Social APIs** (X, etc.):
  👉 **[X API](sub-skills/x-api/SKILL.md)**
- For **Crossposting** and Syndication:
  👉 **[Crosspost](sub-skills/crosspost/SKILL.md)**

### 4. Resilience & Evolution
- For **Resilience Patterns** and Fault Tolerance:
...
- For **Deep Codebase Analysis** and Structural Diagrams:
  👉 **[Code Architect](sub-skills/code-architect/SKILL.md)**
- For **Scalable API Design** and Microservices Patterns:
