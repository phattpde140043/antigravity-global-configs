...
- For **Ad Creative & Copy Strategist** (Google/Meta ads, media orchestration via Remotion, ElevenLabs, flux):
  👉 **[Ad Creative Strategist](sub-skills/ad-creative/SKILL.md)**
- For **Audience Awareness Stage Mapping & Persuasion** (behavioral psychology messaging):
  👉 **[Awareness Stage Mapper](sub-skills/awareness-stage-mapper/SKILL.md)**
- For **Business Analysis & Requirements Gathering** (requirements documentation, stakeholder alignment, user stories):
...
- For **Product Analytics & Metrics** (PostHog, Mixpanel cohorts, A/B test significance):
  👉 **[Analytics Product](sub-skills/analytics-product/SKILL.md)**
- For **Measurement Strategy & Tracking** (GA4, GTM, dataLayer validation, signal quality index):
