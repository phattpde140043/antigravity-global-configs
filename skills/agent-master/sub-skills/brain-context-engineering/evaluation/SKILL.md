...
This skill is a vital link in the **[@brain-context-engineering](../SKILL.md)** master chain. Evaluation must be applied across all context engineering dimensions:
