...
**Scope:** This skill is for **initial ideation and design** — generating ideas from scratch.
- To stress-test an **already-formed plan** against domain model and ADRs → use `grill-with-docs` instead.
- To write an **implementation plan** from an approved design → use `writing-plans` instead.
</HARD-GATE>
...
- Write the validated design (spec) to `docs/superpowers/specs/YYYY-MM-DD-<topic>-design.md`
  ...
  - **OSP Search E2E project:** Use `analyze-reports/` instead of `docs/superpowers/specs/`
